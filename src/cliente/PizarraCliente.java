...
public class PizarraCliente extends javax.swing.JFrame{
    ...
    public PizarraCliente() {
        ...
        MouseAdapter m= new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                if(e.isPopupTrigger()){
                   ...
                   // menuClick.setLocation(e.getLocationOnScreen());
                }
       ...
       // this.addFocusListener(new Repintador());
...
class Pintador extends MouseMotionAdapter {
	...
	//g.clipRect(10,10,(int)comp.getWidth()-20,(int)comp.getHeight()-20);
...
public void pintar(int x, int y, int aSetear){
	...
	//g.clipRect(10,10,(int)c.getWidth()-20,(int)c.getHeight()-20);
	//g.fillOval(x,y,3,3);
